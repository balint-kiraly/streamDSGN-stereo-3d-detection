...
class AnchorHeadTemplate(nn.Module):
        ...
        if self.do_feature_imitation:
            ...
            for cfg in cfgs:
                ...
                if cfg.normalize is not None:
                    self.norm_imitation[cfg.stereo_feature_layer] = NormalizeLayer(
    ...
    def get_imitation_reg_layer_loss(self, features_preds, features_targets, imitation_cfg):
        ...
        pos_feature_targets = self.norm_imitation[imitation_cfg.stereo_feature_layer](
        ...
        imitation_loss = imitation_loss * \
            self.model_cfg.LOSS_CONFIG.LOSS_WEIGHTS['imitation_weight']
    ...
    def get_loss(self):
        ...
        if 'imitation_features_pairs' in self.forward_ret_dict:
            ...
            for feature_pairs in self.forward_ret_dict["imitation_features_pairs"]:
                ...
                tag = (
                    '_' + feature_pairs['stereo_feature_name']) if npairs > 1 else ''
