...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='feature_flow_cuda',
                module='pcdet.ops.feature_flow',
                sources=[
                    'src/feature_flow_api.cpp',
                    'src/feature_adjusting_kernel.cu',
                    'src/feature_adjusting.cpp',
                    'src/feature_sweeping_kernel.cu',
                    'src/feature_sweeping.cpp',
                ]
            ),
            make_cuda_ext(
                name='correlation_cuda',
                module='pcdet.ops.correlation_package',
                sources=[
